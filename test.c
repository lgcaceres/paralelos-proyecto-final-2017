...
int main(int argc, char **argv)
{
  ...
  struct option long_options[] = {
    ...
    {"priority-queue",            required_argument, 0, 'p'},
    {"linden",                    required_argument, 0, 'L'},
    {"spray-list",                required_argument, 0, 'l'},
    {"event-simulator",           required_argument, 0, 'e'},
    {"initial-size",              required_argument, 0, 'i'},
    {"num-threads",               required_argument, 0, 'n'},
    {"range",                     required_argument, 0, 'r'},
    {"seed",                      required_argument, 0, 's'},
    {"update-rate",               required_argument, 0, 'u'},
    {"elasticity",                required_argument, 0, 'x'},
    {"nothing",                   required_argument, 0, 'l'},
    {0, 0, 0, 0}
  };
